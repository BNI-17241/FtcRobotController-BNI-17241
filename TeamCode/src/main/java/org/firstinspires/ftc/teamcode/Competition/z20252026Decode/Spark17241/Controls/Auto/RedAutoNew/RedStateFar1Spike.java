package org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Controls.Auto.RedAutoNew;
...
import org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Controls.Auto.StateAutoMain;
import org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.pedroPathing.MainContraints;
@Disabled
...
public class RedStateFar1Spike extends StateAutoMain {
    ...
    //--------------Config for paths-----------------------
    //Start Pose
    public final Pose StartingPose = RedFarStartPose;
    //Shoot Pose
    public final Pose ShootingPose = RedFarShootPose;
    //Park Pose
    public final Pose ParkingPose = RedFarParkPose;

    //Optional Pose for shooting after Third Spike
    public final Pose ThirdShootPose = RedFarShootPose;
    ...
    */
    ...
    public void pathGen(){
        ...
        spike2_to_fire = follower
                ...
                .setLinearHeadingInterpolation(RedSpikeBOutsidePose.getHeading(), ShootingPose.getHeading())
                .build();
        ...
        spike3_to_fire = follower
                ...
                .setLinearHeadingInterpolation(RedSpikeCOutsidePose.getHeading(), ShootingPose.getHeading())
                .build();
