package org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Controls.Auto;
...
public abstract class StateAutoMain extends OpMode {
    ...
    public final Pose BlueSpikeDInsidePose = new Pose(13, 28, Math.toRadians(270));
    public final Pose BlueSpikeDOutsidePose = new Pose(13, 10, Math.toRadians(270));
    //----------------------------------------------------------
    ...
    public final Pose RedSpikeDInsidePose = new Pose(131, 28, Math.toRadians(270));
    public final Pose RedSpikeDOutsidePose = new Pose(131, 28, Math.toRadians(270));
