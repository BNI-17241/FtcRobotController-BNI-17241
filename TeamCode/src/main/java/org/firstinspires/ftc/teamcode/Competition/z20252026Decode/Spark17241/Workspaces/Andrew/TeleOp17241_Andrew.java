package org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew;
...
public class TeleOp17241_Andrew extends OpMode {
    ...
    public org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.singleFeedStates singleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.singleFeedStates.READY;
    ...
    public org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.multipleFeedStates multipleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.multipleFeedStates.READY;
    ...
    public void feedStatesSingleLoad() {
        switch (singleFeedState) {
            case START:
                decBot.feedArtifact(1.0);
                timer.reset();
                singleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.singleFeedStates.PAUSE;
                break;
            case PAUSE:
                if (timer.time() > 0.3) {
                    singleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.singleFeedStates.STOP;
                }
                break;
            case STOP:
                decBot.feedArtifact(0.0);
                singleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.singleFeedStates.READY;
                break;
            case READY:
                break;
        }
    ...
    public void feedStatesMultipleLoad() {
        switch (multipleFeedState) {
            case START_1:
                decBot.feedArtifact(1.0);
                timer.reset();
                multipleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.multipleFeedStates.PAUSE_1;
                break;
            case PAUSE_1:
                if (timer.time() > 0.3) {
                    multipleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.multipleFeedStates.STOP_1;
                }
                break;
            case STOP_1:
                decBot.feedArtifact(0.0);
                timer.reset();
                multipleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.multipleFeedStates.WAIT_1;
                break;
            case WAIT_1:
                if (timer.time() > .5) {
                    multipleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.multipleFeedStates.START_2;
                }
                break;
            case START_2:
                decBot.feedArtifact(1.0);
                timer.reset();
                multipleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.multipleFeedStates.PAUSE_2;
                break;
            case PAUSE_2:
                if (timer.time() > 0.3) {
                    multipleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.multipleFeedStates.STOP_2;
                }
                break;
            case STOP_2:
                decBot.feedArtifact(0.0);
                timer.reset();
                multipleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.multipleFeedStates.WAIT_2;
                break;
            case WAIT_2:
                if (timer.time() > 0.5) {
                    multipleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.multipleFeedStates.START_3;
                }
                break;
            case START_3:
                decBot.feedArtifact(1.0);
                timer.reset();
                multipleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.multipleFeedStates.PAUSE_3;
                break;
            case PAUSE_3:
                if (timer.time() > 0.3) {
                    multipleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.multipleFeedStates.STOP_3;
                }
                break;
            case STOP_3:
                decBot.feedArtifact(0.0);
                timer.reset();
                multipleFeedState = org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Andrew.TeleOp17241_Andrew.multipleFeedStates.READY;
                break;
            case READY:
                break;
        }
