...
public abstract class StateVarableMainBackUp extends StateAutoMainBackUp {
    ...
    public Pose SecountShootingPose;
    public Pose ThirdShootingPose;
    ...
    */
    ...
    public void pathGen() {
        ...
        fire_to_spike2 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(SecountShootingPose, BlueSpikeBInsidePose)
                )
                .setLinearHeadingInterpolation(SecountShootingPose.getHeading(), BlueSpikeBInsidePose.getHeading())
                .build();

        fire_to_spike3 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(ThirdShootingPose, BlueSpikeCInsidePose)
                )
                .setLinearHeadingInterpolation(ThirdShootingPose.getHeading(), BlueSpikeCInsidePose.getHeading())
                .build();
        ...
        spike1_to_fire = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(BlueSpikeAOutsidePose, FirstShootingPose)
                )
                .setLinearHeadingInterpolation(BlueSpikeAOutsidePose.getHeading(), FirstShootingPose.getHeading())
                .build();

        spike2_to_fire = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(BlueSpikeBOutsidePose, SecountShootingPose)
                )
                .setLinearHeadingInterpolation(BlueSpikeBOutsidePose.getHeading(), SecountShootingPose.getHeading())
                .build();

        spike3_to_fire = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(BlueSpikeCOutsidePose, ThirdShootingPose)
                )
                .setLinearHeadingInterpolation(BlueSpikeCOutsidePose.getHeading(), ThirdShootingPose.getHeading())
                .build();

        fire_to_park = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(FirstShootingPose, ParkingPose)
                )
                .setLinearHeadingInterpolation(FirstShootingPose.getHeading(), ParkingPose.getHeading())
                .build();
        ...
        if (AtoCIntake) {
            ...
            third_spike_to_shoot = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(BlueSpikeAOutsidePose, ThirdShootingPose)
                    )
                    .setLinearHeadingInterpolation(BlueSpikeAOutsidePose.getHeading(), ThirdShootingPose.getHeading())
                    .build();
        }
    }
