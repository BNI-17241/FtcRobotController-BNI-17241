...
public class MainContraints {


    // Weight of Robot
    public static FollowerConstants followerConstants = new FollowerConstants()
            .mass(20.1)   // Kilograms of Robot Weighed on 1/17 oz
            .forwardZeroPowerAcceleration(-30.889)    // Tested on 1/19 (Andrew)
            .lateralZeroPowerAcceleration(-60.201);   // Tested on 1/19 (Andrew)
    ...
    public static MecanumConstants driveConstants = new MecanumConstants()
            ...
            .xVelocity(64.20)    // Tested on 1/19 (Andrew)
            .yVelocity(54.43);   // Tested on 1/19 (Andrew)
