package org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Acker;
...
import org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Controls.Auto.Old.AutoMain;
import org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.pedroPathing.ProgramConstants;

@Disabled
@Autonomous(name = "Tester 2: Slow Red:Start Human:Park Spike", group = "Drive")
public class RedStartHumanParkSpikeSLOW2 extends AutoMain {
//
    ...
    public void buildPaths() {
        ...
        goPark = new Path(new BezierLine(scorePose, parkPose));
        goPark.setLinearHeadingInterpolation(scorePose.getHeading(), parkPose.getHeading());
