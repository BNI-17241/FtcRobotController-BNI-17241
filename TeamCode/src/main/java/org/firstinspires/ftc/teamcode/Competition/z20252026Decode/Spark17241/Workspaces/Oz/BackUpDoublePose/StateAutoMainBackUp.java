package org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Workspaces.Oz.BackUpDoublePose;

import com.pedropathing.geometry.Pose;
import com.qualcomm.robotcore.eventloop.opmode.OpMode;
import com.qualcomm.robotcore.hardware.DcMotor;

import org.firstinspires.ftc.teamcode.Competition.z20252026Decode.Spark17241.Robots.StateDecodeBot;
...
public abstract class StateAutoMainBackUp extends OpMode {
    ...
    public static final Pose BlueMidFirstShootPose = new Pose(57, 83, Math.toRadians(13));// Blue goal scoring pose
    public static final Pose BlueMidSecountShootPose = new Pose(57, 83, Math.toRadians(13));
    public static final Pose BlueMidThirdShootPose = new Pose(57, 83, Math.toRadians(13));

    public static final Pose BlueFarFirstShootPose = new Pose(60, 20, Math.toRadians(108));// Blue goal scoring pose from small triangle
    public static final Pose BlueFarSecountShootPose = new Pose(60, 20, Math.toRadians(110));
    public static final Pose BLueFarThirdShootPose = new Pose(60, 20, Math.toRadians(112));
    ...
    public final Pose RedMidSecoundShootPose = new Pose(85, 81, Math.toRadians(45));// Red goal scoring pose
    public final Pose RedMidThirdShootPose = new Pose(85, 81, Math.toRadians(45));// Red goal scoring pose


    public final Pose RedFarFirstShootPose =  new Pose(84, 20, Math.toRadians(64)); // Red goal scoring pose from small triangle
    public final Pose RedFarSecountShootPose =  new Pose(84, 20, Math.toRadians(62)); // Red goal scoring pose from small triangle
    public final Pose RedFarThirdShootPose =  new Pose(84, 20, Math.toRadians(60)); // Red goal scoring pose from small triangle
