...
public abstract class StateAutoMain extends OpMode {
    ...
    public final Pose BlueSpikeCOutsidePose = new Pose(16, 82, Math.toRadians(180));
    //----------------------------------------------------------
    ...
    public final Pose RedSpikeAOutsidePose = new Pose(125, 32, Math.toRadians(0));

    public final Pose RedSpikeBInsidePose = new Pose(105, 58, Math.toRadians(0)); // secount clostest 22
    public final Pose RedSpikeBOutsidePose = new Pose(125, 58, Math.toRadians(0));

    public final Pose RedSpikeCInsidePose = new Pose(105, 82, Math.toRadians(0)); // third closest 21
    public final Pose RedSpikeCOutsidePose = new Pose(125, 82, Math.toRadians(0));
