...
public abstract class StateAutoMain extends OpMode {
    ...
    public final Pose BlueSpikeAInsidePose = new Pose(48, 30, Math.toRadians(180));
    public final Pose BlueSpikeAOutsidePose = new Pose(17, 30, Math.toRadians(180));

    // Middle spike
    public final Pose BlueSpikeBInsidePose = new Pose(48, 56, Math.toRadians(180));;
    public final Pose BlueSpikeBOutsidePose = new Pose(17, 56, Math.toRadians(180));

    //Farthest Spike
    public final Pose BlueSpikeCInsidePose = new Pose(48, 80, Math.toRadians(180));
    public final Pose BlueSpikeCOutsidePose = new Pose(17, 80, Math.toRadians(180));
    //----------------------------------------------------------
    ...
    public final Pose RedSpikeAInsidePose = new Pose(105, 31, Math.toRadians(0)); // closest to human 23
    public final Pose RedSpikeAOutsidePose = new Pose(124, 31, Math.toRadians(0));

    public final Pose RedSpikeBInsidePose = new Pose(105, 56, Math.toRadians(0)); // secount clostest 22
    public final Pose RedSpikeBOutsidePose = new Pose(124, 56, Math.toRadians(0));

    public final Pose RedSpikeCInsidePose = new Pose(105, 80, Math.toRadians(0)); // third closest 21
    public final Pose RedSpikeCOutsidePose = new Pose(124, 80, Math.toRadians(0));
